...
<head>
  ...
  <body>
    ...
    <div class="iosSnowLayer" id="iosSnowLayer" aria-hidden="true">
      ...
      <span class="iosSnowFlake" style="left:12%;width:6px;height:6px;animation-duration:34.5s;animation-delay:-30s;--snowOpacity:.34;--snowDrift:21px"></span>
      <span class="iosSnowFlake" style="left:24%;width:5px;height:5px;animation-duration:33.5s;animation-delay:-19s;--snowOpacity:.29;--snowDrift:17px"></span>
      <span class="iosSnowFlake" style="left:34%;width:4px;height:4px;animation-duration:37s;animation-delay:-25s;--snowOpacity:.25;--snowDrift:14px"></span>
      <span class="iosSnowFlake" style="left:46%;width:6px;height:6px;animation-duration:35.5s;animation-delay:-31s;--snowOpacity:.35;--snowDrift:23px"></span>
      <span class="iosSnowFlake" style="left:57%;width:5px;height:5px;animation-duration:38s;animation-delay:-27s;--snowOpacity:.30;--snowDrift:18px"></span>
      <span class="iosSnowFlake" style="left:68%;width:4px;height:4px;animation-duration:36.5s;animation-delay:-22s;--snowOpacity:.26;--snowDrift:16px"></span>
      <span class="iosSnowFlake" style="left:79%;width:6px;height:6px;animation-duration:39s;animation-delay:-33s;--snowOpacity:.34;--snowDrift:24px"></span>
      <span class="iosSnowFlake" style="left:91%;width:5px;height:5px;animation-duration:37.5s;animation-delay:-18s;--snowOpacity:.29;--snowDrift:19px"></span>
      <span class="iosSnowFlake" style="left:3%;width:4px;height:4px;animation-duration:40s;animation-delay:-37s;--snowOpacity:.27;--snowDrift:14px"></span>
      <span class="iosSnowFlake" style="left:17%;width:6px;height:6px;animation-duration:41s;animation-delay:-35s;--snowOpacity:.35;--snowDrift:23px"></span>
      <span class="iosSnowFlake" style="left:27%;width:5px;height:5px;animation-duration:39.5s;animation-delay:-38s;--snowOpacity:.31;--snowDrift:17px"></span>
      <span class="iosSnowFlake" style="left:41%;width:4px;height:4px;animation-duration:42s;animation-delay:-40s;--snowOpacity:.26;--snowDrift:15px"></span>
      <span class="iosSnowFlake" style="left:52%;width:6px;height:6px;animation-duration:40.5s;animation-delay:-36s;--snowOpacity:.35;--snowDrift:24px"></span>
      <span class="iosSnowFlake" style="left:64%;width:5px;height:5px;animation-duration:41.5s;animation-delay:-39s;--snowOpacity:.30;--snowDrift:18px"></span>
      <span class="iosSnowFlake" style="left:76%;width:4px;height:4px;animation-duration:43s;animation-delay:-41s;--snowOpacity:.26;--snowDrift:16px"></span>
      <span class="iosSnowFlake" style="left:88%;width:6px;height:6px;animation-duration:42.5s;animation-delay:-34s;--snowOpacity:.34;--snowDrift:22px"></span>
      <span class="iosSnowFlake" style="left:8%;width:5px;height:5px;animation-duration:44s;animation-delay:-43s;--snowOpacity:.30;--snowDrift:19px"></span>
      <span class="iosSnowFlake" style="left:22%;width:4px;height:4px;animation-duration:45s;animation-delay:-44s;--snowOpacity:.27;--snowDrift:15px"></span>
      <span class="iosSnowFlake" style="left:36%;width:6px;height:6px;animation-duration:43.5s;animation-delay:-42s;--snowOpacity:.35;--snowDrift:23px"></span>
      <span class="iosSnowFlake" style="left:60%;width:4px;height:4px;animation-duration:46s;animation-delay:-45s;--snowOpacity:.27;--snowDrift:16px"></span>
      <span class="iosSnowFlake" style="left:72%;width:5px;height:5px;animation-duration:44.5s;animation-delay:-43s;--snowOpacity:.31;--snowDrift:18px"></span>
      <span class="iosSnowFlake" style="left:93%;width:4px;height:4px;animation-duration:45.5s;animation-delay:-44s;--snowOpacity:.27;--snowDrift:15px"></span>
        </div>
    <div class="statusBar">
    ...
    <div class="wrap">
      <div class="card">
        <div class="cardSnowLayer" id="cardSnowLayer" aria-hidden="true">
          ...
          <span class="cardSnowFlake" style="left:9%;width:6px;height:6px;animation-duration:38.5s;animation-delay:-32s;--snowOpacity:.36;--snowDrift:22px"></span>
          <span class="cardSnowFlake" style="left:19%;width:5px;height:5px;animation-duration:39s;animation-delay:-28s;--snowOpacity:.31;--snowDrift:18px"></span>
          <span class="cardSnowFlake" style="left:31%;width:4px;height:4px;animation-duration:40s;animation-delay:-34s;--snowOpacity:.26;--snowDrift:16px"></span>
          <span class="cardSnowFlake" style="left:44%;width:6px;height:6px;animation-duration:39.5s;animation-delay:-30s;--snowOpacity:.37;--snowDrift:24px"></span>
          <span class="cardSnowFlake" style="left:58%;width:5px;height:5px;animation-duration:41s;animation-delay:-36s;--snowOpacity:.32;--snowDrift:20px"></span>
          <span class="cardSnowFlake" style="left:70%;width:4px;height:4px;animation-duration:38s;animation-delay:-26s;--snowOpacity:.26;--snowDrift:15px"></span>
          <span class="cardSnowFlake" style="left:81%;width:6px;height:6px;animation-duration:40.5s;animation-delay:-35s;--snowOpacity:.36;--snowDrift:23px"></span>
          <span class="cardSnowFlake" style="left:94%;width:5px;height:5px;animation-duration:39s;animation-delay:-29s;--snowOpacity:.31;--snowDrift:18px"></span>
          <span class="cardSnowFlake" style="left:2%;width:4px;height:4px;animation-duration:42s;animation-delay:-38s;--snowOpacity:.28;--snowDrift:13px"></span>
          <span class="cardSnowFlake" style="left:11%;width:6px;height:6px;animation-duration:43s;animation-delay:-40s;--snowOpacity:.36;--snowDrift:23px"></span>
          <span class="cardSnowFlake" style="left:25%;width:5px;height:5px;animation-duration:41.5s;animation-delay:-37s;--snowOpacity:.31;--snowDrift:18px"></span>
          <span class="cardSnowFlake" style="left:39%;width:4px;height:4px;animation-duration:44s;animation-delay:-41s;--snowOpacity:.27;--snowDrift:14px"></span>
          <span class="cardSnowFlake" style="left:51%;width:6px;height:6px;animation-duration:42.5s;animation-delay:-39s;--snowOpacity:.36;--snowDrift:24px"></span>
          <span class="cardSnowFlake" style="left:63%;width:5px;height:5px;animation-duration:43.5s;animation-delay:-42s;--snowOpacity:.31;--snowDrift:19px"></span>
          <span class="cardSnowFlake" style="left:78%;width:4px;height:4px;animation-duration:41s;animation-delay:-36s;--snowOpacity:.27;--snowDrift:15px"></span>
          <span class="cardSnowFlake" style="left:91%;width:6px;height:6px;animation-duration:44.5s;animation-delay:-40s;--snowOpacity:.35;--snowDrift:22px"></span>
          <span class="cardSnowFlake" style="left:7%;width:5px;height:5px;animation-duration:45s;animation-delay:-43s;--snowOpacity:.31;--snowDrift:18px"></span>
          <span class="cardSnowFlake" style="left:18%;width:4px;height:4px;animation-duration:46s;animation-delay:-44s;--snowOpacity:.27;--snowDrift:15px"></span>
          <span class="cardSnowFlake" style="left:29%;width:6px;height:6px;animation-duration:44.5s;animation-delay:-42s;--snowOpacity:.36;--snowDrift:23px"></span>
          <span class="cardSnowFlake" style="left:47%;width:4px;height:4px;animation-duration:45.5s;animation-delay:-45s;--snowOpacity:.28;--snowDrift:16px"></span>
          <span class="cardSnowFlake" style="left:69%;width:5px;height:5px;animation-duration:46.5s;animation-delay:-44s;--snowOpacity:.31;--snowDrift:19px"></span>
          <span class="cardSnowFlake" style="left:86%;width:4px;height:4px;animation-duration:45s;animation-delay:-43s;--snowOpacity:.27;--snowDrift:15px"></span>
        </div>
        <div class="top">
          <div class="brand">
