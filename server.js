...
function baseStyles() {
  ...
  <style>
    ...
    *{font-family:"Alata", Arial, sans-serif}
    ...
    .loginIntro{position:relative;z-index:1;margin:0 0 20px;text-align:center}
    .loginEyebrow{
      display:inline-flex;
      align-items:center;
      justify-content:center;
    ...
    .loginTitle{font-size:clamp(42px,8vw,58px);color:#fff7db;margin:0 0 10px;letter-spacing:.18px;text-shadow:0 0 28px rgba(255,224,130,.18),0 0 40px rgba(255,255,255,.06)}
    .loginHint{margin:0 auto;color:#e3d9c1;font-size:clamp(15px,2.3vw,18px);line-height:1.7;max-width:34rem;overflow-wrap:anywhere;word-break:break-word}
    .loginAccent{
      width:min(92px,36%);
      height:1px;
      margin:18px auto 0;
    ...
    .loginIconRow{display:flex;align-items:center;justify-content:center;gap:clamp(42px,9vw,70px);margin-top:24px}
    .loginIconLink{
      width:86px;height:86px;border-radius:50%;
      display:inline-flex;align-items:center;justify-content:center;text-decoration:none;
      background:linear-gradient(180deg, rgba(255,255,255,.08), rgba(255,255,255,.03));
      border:1px solid rgba(255,255,255,.08);
      box-shadow:inset 0 1px 0 rgba(255,255,255,.05), 0 12px 24px rgba(0,0,0,.12);
      transition:transform .24s ease, filter .24s ease, border-color .24s ease
    }
    .loginIconLink:hover{transform:translateY(-2px);filter:drop-shadow(0 0 18px rgba(255,224,130,.16));border-color:rgba(255,236,185,.14)}
