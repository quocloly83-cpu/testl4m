...
function baseStyles() {
  ...
  <style>
    ...
    *{font-family:"Alata", Arial, sans-serif}
    ...
    .quickStats{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:12px;margin:14px 0 16px}
    .statChip{
      position:relative;overflow:hidden;
      padding:14px 14px 15px;border-radius:22px;backdrop-filter:blur(12px);
      background:
        radial-gradient(circle at top right, rgba(168,132,255,.08), transparent 34%),
        linear-gradient(180deg, rgba(255,255,255,.07), rgba(255,255,255,.025));
      border:1px solid rgba(255,255,255,.08);
      box-shadow:inset 0 1px 0 rgba(255,255,255,.05), 0 14px 28px rgba(0,0,0,.12);
    }
    .statChip::before{
      content:"";
      position:absolute;
    ...
    .statLabel{
      display:block;font-size:11px;color:#c7b8e0;margin-bottom:6px;
      letter-spacing:.8px;text-transform:uppercase
    }
    .statChip strong{font-size:15px;line-height:1.35;color:#fff7e6}
    .loginHero{
      position:relative;
      padding:clamp(22px,3.8vw,36px) 0 clamp(14px,2.4vw,20px);
    ...
    .loginIntro{position:relative;z-index:1;margin:0 0 18px}
    .loginEyebrow{
      display:inline-flex;
      align-items:center;
      justify-content:center;
    ...
    .loginTitle{font-size:clamp(32px,5.4vw,42px);color:#fff7db;margin:0 0 10px;letter-spacing:.34px;text-shadow:0 0 28px rgba(255,224,130,.22),0 0 46px rgba(255,255,255,.08)}
    .loginHint{margin:0 auto;color:#ddd2b2;font-size:clamp(14px,2.05vw,16px);line-height:1.78;max-width:30rem;overflow-wrap:anywhere;word-break:break-word}
    .loginAccent{
      width:min(92px,36%);
      height:1px;
      margin:18px auto 0;
    ...
    .loginFrame{
      ...
      min-height:auto;
      margin:0 auto;
      padding:clamp(28px,4vw,38px) clamp(18px,3.4vw,28px) clamp(20px,3vw,24px);
      display:flex;flex-direction:column;align-items:center;justify-content:center;text-align:center;gap:0;
      border-radius:32px;
      background:
        radial-gradient(circle at 18% 18%, rgba(168,132,255,.13), transparent 28%),
        radial-gradient(circle at 82% 14%, rgba(228,205,151,.10), transparent 28%),
        linear-gradient(180deg, rgba(14,16,24,.94), rgba(9,10,16,.97));
      border:1px solid rgba(255,255,255,.08);
      box-shadow:
        0 26px 72px rgba(0,0,0,.34),
        inset 0 1px 0 rgba(255,255,255,.06),
        0 0 0 1px rgba(168,132,255,.04);
      overflow:hidden;
      isolation:isolate;
    }
    .loginFrame::before{
      ...
      position:absolute;
      inset:0;
      background:linear-gradient(180deg, rgba(255,255,255,.035), transparent 36%);
      pointer-events:none;
    }
    .loginFrame::after{
      content:"";
      ...
      height:220px;
      border-radius:50%;
      background:radial-gradient(circle, rgba(116,92,255,.16), transparent 68%);
      filter:blur(8px);
      pointer-events:none;
    }
    .loginCenterLogo{
    ...
    .loginCenterAura{
      ...
      inset:10px;
      border-radius:50%;
      background:radial-gradient(circle, rgba(168,132,255,.24), transparent 68%);
      filter:blur(12px);
    }
    .loginCenterRing{
      position:absolute;
      ...
      box-shadow:0 0 0 6px rgba(168,132,255,.06), 0 0 26px rgba(168,132,255,.16);
    }
    .loginCenterCore{
      position:relative;
      width:96px;
    ...
    .loginFeatureTick{
      ...
      border:1px solid rgba(73,255,154,.34);
      box-shadow:0 0 16px rgba(57,225,136,.16);
      color:#7dffba;
      font-size:12px;
    ...
    .input{
      width:100%;height:clamp(58px,7.4vh,66px);border:none;outline:none;border-radius:22px;padding:0 clamp(18px,3vw,22px);
    ...
    #loginView .loginPrimaryBtn{
      height:58px;
      background:linear-gradient(92deg,#a684ff,#e4cd97,#f4ebdf);
      color:#120d1a;
      font-weight:800;
      letter-spacing:.24px;
      border:1px solid rgba(255,255,255,.18);
      box-shadow:0 20px 34px rgba(0,0,0,.22), 0 0 28px rgba(168,132,255,.10), inset 0 1px 0 rgba(255,255,255,.30);
    }
    #loginView .loginPrimaryBtn:hover{
      transform:translateY(-1px);
      box-shadow:0 22px 40px rgba(0,0,0,.24), 0 0 30px rgba(168,132,255,.14), inset 0 1px 0 rgba(255,255,255,.32);
    }
    #loginView .loginFreeBtn{
      ...
      border:1px solid rgba(255,255,255,.08);
      color:#f2ead9;
      box-shadow:inset 0 1px 0 rgba(255,255,255,.04), 0 12px 24px rgba(0,0,0,.10);
    }
    .loginSupportDock{
      display:grid;
      grid-template-columns:repeat(2,minmax(0,1fr));
    ...
    .loginSupportBtn{
      ...
      border:1px solid rgba(255,255,255,.07);
      box-shadow:inset 0 1px 0 rgba(255,255,255,.04), 0 10px 20px rgba(0,0,0,.08);
      transition:transform .18s ease, box-shadow .18s ease, border-color .18s ease;
    }
    .loginSupportBtn:hover{
      transform:translateY(-1px);
      border-color:rgba(214,196,154,.18);
      box-shadow:inset 0 1px 0 rgba(255,255,255,.05), 0 12px 24px rgba(0,0,0,.10);
    }
    .loginSupportBtn span{
      font-size:13px;
      font-weight:700;
      letter-spacing:.12px;
    }
    ...
    .topLine{display:flex;align-items:center;justify-content:space-between;gap:12px;margin-bottom:16px;flex-wrap:wrap}
    .topLineMain{display:flex;flex-direction:column;gap:8px;flex:1 1 220px;min-width:0}
    .topLineHint{
      padding-left:2px;
      color:#bcb3cb;
      font-size:12px;
    ...
    .pillAccent{
      background:linear-gradient(92deg, rgba(166,132,255,.28), rgba(228,205,151,.20), rgba(255,255,255,.05));
      border-color:rgba(255,236,185,.18);
      color:#fff7df;
      box-shadow:inset 0 1px 0 rgba(255,255,255,.08), 0 14px 28px rgba(0,0,0,.14), 0 0 24px rgba(168,132,255,.10);
    }
    .noticeBox{
      position:relative;overflow:hidden;
      margin-top:12px;padding:18px;border-radius:26px;
      background:
        radial-gradient(circle at 100% 0%, rgba(168,132,255,.14), transparent 34%),
        radial-gradient(circle at 0% 100%, rgba(228,205,151,.10), transparent 34%),
        linear-gradient(180deg, rgba(16,18,28,.96), rgba(10,11,18,.98));
      border:1px solid rgba(255,255,255,.08);
      font-size:13px;color:#efe7ff;line-height:1.6;overflow-wrap:anywhere;word-break:break-word;
    ...
    .noticeBox::before{
      ...
      background:linear-gradient(90deg, transparent, rgba(255,236,185,.40), transparent);
      pointer-events:none;
    }
    .noticeHeader{display:flex;align-items:flex-start;justify-content:space-between;gap:12px;flex-wrap:wrap;position:relative;z-index:1}
    .noticeEyebrow{
      margin:0 0 6px;
      color:#c9b8ff;
      font-size:10px;
    ...
    .noticeStatus{
      ...
      background:linear-gradient(180deg, rgba(57,225,136,.16), rgba(255,255,255,.04));
      border:1px solid rgba(118,255,172,.22);
      color:#d4ffe7;
      font-size:11px;
      font-weight:800;
      letter-spacing:1px;
      text-transform:uppercase;
      box-shadow:0 0 18px rgba(57,225,136,.10), inset 0 1px 0 rgba(255,255,255,.06);
    }
    .noticeGrid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:10px;position:relative;z-index:1}
    .noticeItem{
    ...
    .noticeValue{
      ...
      .tabs{
        display:grid;grid-template-columns:repeat(4,1fr);gap:10px;margin:22px 0 18px;padding:8px;
        border-radius:24px;
        background:linear-gradient(180deg, rgba(13,14,22,.96), rgba(13,14,22,.74));
        border:1px solid rgba(255,255,255,.06);
        box-shadow:inset 0 1px 0 rgba(255,255,255,.04), 0 14px 30px rgba(0,0,0,.10);
      }
    .tab{
      height:52px;border-radius:16px;border:1px solid rgba(255,255,255,.06);
      background:linear-gradient(180deg, rgba(255,255,255,.07), rgba(255,255,255,.03));
      font-size:13px;padding:0 10px;font-weight:800;letter-spacing:.08em;text-transform:uppercase;color:#ece4f6
    }
    .tab.active{
      color:#17111f;
      background:linear-gradient(90deg,#a684ff,#e4cd97,#f3ebdf);
      box-shadow:0 14px 28px rgba(0,0,0,.18), 0 0 24px rgba(168,132,255,.14), inset 0 1px 0 rgba(255,255,255,.26)
    }
    .tabPane{display:none}
    .tabPane.active{display:block}
    .tile{
      padding:18px 18px 16px;border-radius:26px;margin-bottom:14px;
      background:
        radial-gradient(circle at top right, rgba(168,132,255,.08), transparent 36%),
    ...
    .name{margin:0;font-size:17px;color:#fff7e4;overflow-wrap:anywhere;word-break:break-word}
    .desc{margin:6px 0 0;color:#c1b9d4;font-size:12.5px;line-height:1.6;overflow-wrap:anywhere;word-break:break-word}
    .switch{position:relative;width:68px;height:38px;flex:0 0 68px}
    ...
    .slider:before{
      content:"";position:absolute;width:30px;height:30px;left:4px;top:3px;border-radius:50%;
    ...
    .switch input:checked + .slider{
      background:linear-gradient(90deg,rgba(24,198,94,.86),rgba(121,255,166,.98));border-color:rgba(118,255,172,.42);box-shadow:0 0 0 1px rgba(118,255,172,.14), 0 0 28px rgba(44,228,116,.30)
    }
    .switch input:checked + .slider:before{transform:translateX(30px);box-shadow:0 6px 18px rgba(98,255,155,.26)}
    ...
    .footer{margin-top:10px;text-align:center;font-size:12px;color:#b9b0c9;line-height:1.7;overflow-wrap:anywhere;word-break:break-word}
      .liveFx{
        margin-top:16px;padding:98px 18px 18px;border-radius:28px;
        background:
          radial-gradient(circle at 14% 0%, rgba(97,180,255,.10), transparent 24%),
          radial-gradient(circle at 100% 0%, rgba(168,132,255,.12), transparent 28%),
          linear-gradient(180deg, rgba(7,12,24,.98), rgba(15,10,31,.92));
    ...
    .liveFx::after{
      ...
      .monitorGameBtn{
        min-width:0;height:44px;padding:0 16px;border-radius:18px;border:1px solid rgba(255,255,255,.12);
    ...
    .tab{backdrop-filter:blur(12px)}
    .tab.active{box-shadow:0 0 0 1px rgba(255,255,255,.08),0 14px 32px rgba(183,124,255,.20)}
    ...
    #panelView.panelReveal #liveFxBox{animation-delay:.2s}
      ...
      .credit{font-size:11px}
        ...
        .loginFrame{width:min(100%,100%);min-height:auto;padding:24px 14px 18px;border-radius:28px}
        .loginFrame::before{inset:0}
        .loginFrame::after{width:170px;height:170px;right:-12%;bottom:-12%}
        .loginCenterLogo{width:108px;height:108px;margin-bottom:18px}
        .loginCenterCore{width:84px;height:84px}
        .loginTitle{font-size:30px}
        .loginHint{font-size:13px;max-width:92%}
        .loginFeatureGrid{grid-template-columns:1fr}
        .loginSupportDock{width:min(100%,100%)}
        .topLineMain{flex-basis:100%}
...
<head>
  ...
  <body>
    ...
    <div class="iosSnowLayer" id="iosSnowLayer" aria-hidden="true">
      ...
      <span class="iosSnowFlake" style="left:7%;width:2px;height:2px;animation-duration:32s;animation-delay:-18s;--snowOpacity:.16;--snowDrift:9px"></span>
      <span class="iosSnowFlake" style="left:18%;width:4px;height:4px;animation-duration:31s;animation-delay:-22s;--snowOpacity:.25;--snowDrift:15px"></span>
      <span class="iosSnowFlake" style="left:29%;width:3px;height:3px;animation-duration:33s;animation-delay:-12s;--snowOpacity:.19;--snowDrift:13px"></span>
      <span class="iosSnowFlake" style="left:39%;width:4px;height:4px;animation-duration:34s;animation-delay:-24s;--snowOpacity:.24;--snowDrift:18px"></span>
      <span class="iosSnowFlake" style="left:50%;width:2px;height:2px;animation-duration:30.5s;animation-delay:-20s;--snowOpacity:.14;--snowDrift:8px"></span>
      <span class="iosSnowFlake" style="left:61%;width:4px;height:4px;animation-duration:35s;animation-delay:-26s;--snowOpacity:.23;--snowDrift:16px"></span>
      <span class="iosSnowFlake" style="left:71%;width:3px;height:3px;animation-duration:32.5s;animation-delay:-11s;--snowOpacity:.18;--snowDrift:11px"></span>
      <span class="iosSnowFlake" style="left:83%;width:4px;height:4px;animation-duration:36s;animation-delay:-28s;--snowOpacity:.24;--snowDrift:17px"></span>
      <span class="iosSnowFlake" style="left:97%;width:2px;height:2px;animation-duration:31.5s;animation-delay:-9s;--snowOpacity:.15;--snowDrift:10px"></span>
        </div>
    <div class="statusBar">
    ...
    <div class="wrap">
      <div class="card">
        <div class="cardSnowLayer" id="cardSnowLayer" aria-hidden="true">
          ...
          <span class="cardSnowFlake" style="left:6%;width:2px;height:2px;animation-duration:36s;animation-delay:-24s;--snowOpacity:.14;--snowDrift:9px"></span>
          <span class="cardSnowFlake" style="left:14%;width:4px;height:4px;animation-duration:35s;animation-delay:-22s;--snowOpacity:.24;--snowDrift:14px"></span>
          <span class="cardSnowFlake" style="left:22%;width:3px;height:3px;animation-duration:37s;animation-delay:-27s;--snowOpacity:.17;--snowDrift:11px"></span>
          <span class="cardSnowFlake" style="left:35%;width:5px;height:5px;animation-duration:36.5s;animation-delay:-25s;--snowOpacity:.29;--snowDrift:18px"></span>
          <span class="cardSnowFlake" style="left:45%;width:2px;height:2px;animation-duration:34s;animation-delay:-21s;--snowOpacity:.13;--snowDrift:8px"></span>
          <span class="cardSnowFlake" style="left:55%;width:4px;height:4px;animation-duration:38s;animation-delay:-29s;--snowOpacity:.23;--snowDrift:15px"></span>
          <span class="cardSnowFlake" style="left:65%;width:3px;height:3px;animation-duration:36s;animation-delay:-23s;--snowOpacity:.17;--snowDrift:12px"></span>
          <span class="cardSnowFlake" style="left:75%;width:5px;height:5px;animation-duration:37.5s;animation-delay:-30s;--snowOpacity:.28;--snowDrift:19px"></span>
          <span class="cardSnowFlake" style="left:89%;width:3px;height:3px;animation-duration:35.5s;animation-delay:-20s;--snowOpacity:.18;--snowDrift:10px"></span>
        </div>
        <div class="top">
          <div class="brand">
        ...
        <div id="loginView" class="loginHero">
          <div class="loginFrame">
            <div class="loginCenterLogo">
              <div class="loginCenterAura"></div>
              <div class="loginCenterRing"></div>
              <div class="loginCenterCore">${renderLogo(96, 999)}</div>
            </div>
            <div class="loginIntro">
              <div class="loginEyebrow">Premium Login</div>
              <h2 class="loginTitle">AimTrickHead</h2>
              <p class="loginHint">
                Truy cập panel premium, đồng bộ key cũ và dùng giao diện tối ưu gọn đẹp trên iOS.
              </p>
              <div class="loginAccent"></div>
            </div>

            <div class="loginFeatureGrid">
              <div class="loginFeatureCard"><span class="loginFeatureTick">✓</span><span>Đồng bộ key cũ</span></div>
              <div class="loginFeatureCard"><span class="loginFeatureTick">✓</span><span>FF & FFMAX</span></div>
              <div class="loginFeatureCard"><span class="loginFeatureTick">✓</span><span>Tâm ảo premium</span></div>
              <div class="loginFeatureCard"><span class="loginFeatureTick">✓</span><span>Mượt và gọn hơn</span></div>
            </div>
            ...
            <div class="loginSupportDock">
              <a class="loginSupportBtn" href="${ZALO_URL}" target="_blank" rel="noopener noreferrer" aria-label="Zalo">${iconZalo(22)} <span>Zalo</span></a>
              <a class="loginSupportBtn" href="${FACEBOOK_URL}" target="_blank" rel="noopener noreferrer" aria-label="Facebook">${iconFacebook(20)} <span>Facebook</span></a>
            </div>
            <div class="loginSupportNote">Hỗ trợ nhanh, nhận update mới và lấy key free ngay trong giao diện.</div>
        ...
        <div id="panelView" class="hidden">
          <div class="topLine">
            <div class="topLineMain">
              <div class="pill pillAccent">✦ VIP ACTIVE</div>
              <div class="topLineHint">Panel premium đang hoạt động ổn định, đồng bộ trạng thái nhanh và giữ giao diện gọn đẹp trên mobile.</div>
            </div>
          ...
          <div class="noticeBox" id="keyNotice">
            <div class="noticeHeader">
              <div>
                <div class="noticeEyebrow">Key Runtime</div>
                <div class="noticeTitle">Key đang hoạt động</div>
              </div>
              <div class="noticeStatus">Đã đồng bộ</div>
            </div>
            <div class="noticeGrid">
              <div class="noticeItem">
                <span>Key</span>
                <strong class="noticeValue">--</strong>
              </div>
              <div class="noticeItem">
  ...
  <script>
    ...
    function buildNotice(data) {
      ...
      const safeKeyText = escapeHtml(keyText);
      const safeRemainText = escapeHtml(remainText);
      const safeExpireText = escapeHtml(data.expireText || "--");
      keyNotice.innerHTML =
        '<div class="noticeHeader">' +
          '<div>' +
            '<div class="noticeEyebrow">Key Runtime</div>' +
        ...
        '<div class="noticeGrid">' +
          '<div class="noticeItem">' +
            '<span>Key</span>' +
            '<strong class="noticeValue">' + safeKeyText + '</strong>' +
          '</div>' +
          '<div class="noticeItem">' +
            '<span>Hiệu lực còn</span>' +
            '<strong class="noticeValue">' + safeRemainText + '</strong>' +
          '</div>' +
          '<div class="noticeItem">' +
            '<span>Hết hạn lúc</span>' +
            '<strong class="noticeValue">' + safeExpireText + '</strong>' +
          '</div>' +
        '</div>';
    }
    ...
    if (gameConfirmAccept) {
      gameConfirmAccept.addEventListener("click", function () {
    ...
    if (gameConfirmCancel) {
      gameConfirmCancel.addEventListener("click", function () {
