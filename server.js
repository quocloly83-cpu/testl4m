  ...
  <style>
    ...
    *{font-family:"Alata", Arial, sans-serif}
    ...
    #loginView .loginFreeBtn{
      ...
      border-radius:18px;
      background:linear-gradient(180deg, rgba(255,255,255,.08), rgba(255,255,255,.03));
      border:1px solid rgba(255,236,185,.12);
      color:#fff;
      font-size:18px;
    ...
    .loginIconRow{display:flex;align-items:center;justify-content:center;gap:clamp(42px,9vw,70px);margin-top:22px}
    .loginIconLink{
    ...
    #panelView.panelReveal #liveFxBox{animation-delay:.2s}
      ...
      .credit{font-size:11px}
        ...
        .loginIconRow{gap:28px;margin-top:20px}
        .loginIconLink{width:74px;height:74px}
        ...
        <div id="loginView" class="loginHero">
          <div class="loginFrame">
            ...
            <div class="loginIconRow">
              <a class="loginIconLink" href="${ZALO_URL}" target="_blank" rel="noopener noreferrer" aria-label="Zalo">${iconZalo(42)}</a>
              <a class="loginIconLink" href="${FACEBOOK_URL}" target="_blank" rel="noopener noreferrer" aria-label="Facebook">${iconFacebook(40)}</a>
            </div>
