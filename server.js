  ...
  <style>
    ...
    *{font-family:"Alata", Arial, sans-serif}
    ...
    .pasteBtn{
      ...
      border:1px solid rgba(255,239,176,.16);
      ...
      <div class="content">
        ...
        <div id="loginView" class="loginHero" style="background:transparent;border:none;border-radius:0;box-shadow:none;min-height:auto;display:flex;align-items:stretch;justify-content:flex-start">
          ...
          <div class="inputWrap">
            ...
            <button id="pasteKeyBtn" class="pasteBtn" type="button">Dán key</button>
          </div>
  ...
  <script>
    ...
    async function pasteKeyFromClipboard() {
      ...
      try {
        ...
        if (!text) {
          setMsg("Clipboard đang trống.", "err");
          return;
        }
        keyInputEl.value = text;
        keyInputEl.focus();
        setMsg("Đã dán key.", "ok");
      } catch (err) {
        setMsg("Không đọc được clipboard, hãy dán thủ công.", "err");
      }
    }
...
<head>
  ...
  <style>
    ...
    if (pasteKeyBtn) {
      pasteKeyBtn.addEventListener("click", pasteKeyFromClipboard);
    }
    .adminStack {
      display: grid;
      gap: 16px;
