...
const HUY_BIO_URL = "https://huyfanta.my.canva.site/";
const TIKTOK_URL =
...
<head>
  ...
  <style>
    ...
    .androidUpdateActions{
      ...
      .androidUpdateLinkLine{
        margin-top:16px;
        color:#efe7ff;
        font-size:14px;
        line-height:1.8;
      }
      .androidUpdateLinkLine a{
        color:#f2dfad;
        font-weight:700;
        text-decoration:none;
        border-bottom:1px solid rgba(242,223,173,.42);
      }
    ...
    <div class="androidUpdateWrap">
      <div class="androidUpdateCard">
        ...
        <div class="androidUpdateLead">Android đã update bản mới.</div>
          ...
          <div class="androidUpdateLinkLine">
            Link Bio Của Huy Đây :
            <a href="${HUY_BIO_URL}" target="_blank" rel="noopener noreferrer">Lên Đây Lấy Link Mới : ${HUY_BIO_URL}</a>
          </div>
...
<head>
  ...
  <body>
    ...
    <div class="iosSnowLayer" id="iosSnowLayer" aria-hidden="true">
      <span class="iosSnowFlake" style="left:6%;width:3px;height:3px;animation-duration:16s;animation-delay:-2s;--snowOpacity:.18;--snowDrift:10px"></span>
      <span class="iosSnowFlake" style="left:14%;width:5px;height:5px;animation-duration:20s;animation-delay:-8s;--snowOpacity:.24;--snowDrift:18px"></span>
      <span class="iosSnowFlake" style="left:24%;width:4px;height:4px;animation-duration:17.5s;animation-delay:-5s;--snowOpacity:.20;--snowDrift:14px"></span>
      <span class="iosSnowFlake" style="left:33%;width:3px;height:3px;animation-duration:22s;animation-delay:-11s;--snowOpacity:.16;--snowDrift:22px"></span>
      <span class="iosSnowFlake" style="left:44%;width:5px;height:5px;animation-duration:18.5s;animation-delay:-4s;--snowOpacity:.22;--snowDrift:12px"></span>
      <span class="iosSnowFlake" style="left:56%;width:4px;height:4px;animation-duration:21s;animation-delay:-9s;--snowOpacity:.18;--snowDrift:20px"></span>
      <span class="iosSnowFlake" style="left:66%;width:3px;height:3px;animation-duration:16.5s;animation-delay:-7s;--snowOpacity:.15;--snowDrift:9px"></span>
      <span class="iosSnowFlake" style="left:76%;width:5px;height:5px;animation-duration:19.5s;animation-delay:-13s;--snowOpacity:.24;--snowDrift:16px"></span>
      <span class="iosSnowFlake" style="left:86%;width:4px;height:4px;animation-duration:17s;animation-delay:-6s;--snowOpacity:.19;--snowDrift:13px"></span>
      <span class="iosSnowFlake" style="left:93%;width:3px;height:3px;animation-duration:23s;animation-delay:-10s;--snowOpacity:.15;--snowDrift:24px"></span>
    </div>
    <div class="statusBar">
    ...
    <div class="wrap">
      <div class="card">
        <div class="cardSnowLayer" id="cardSnowLayer" aria-hidden="true">
          <span class="cardSnowFlake" style="left:7%;width:4px;height:4px;animation-duration:15s;animation-delay:-2s;--snowOpacity:.22;--snowDrift:10px"></span>
          <span class="cardSnowFlake" style="left:13%;width:6px;height:6px;animation-duration:18s;animation-delay:-7s;--snowOpacity:.28;--snowDrift:18px"></span>
          <span class="cardSnowFlake" style="left:21%;width:5px;height:5px;animation-duration:16.5s;animation-delay:-4s;--snowOpacity:.22;--snowDrift:14px"></span>
          <span class="cardSnowFlake" style="left:29%;width:4px;height:4px;animation-duration:20s;animation-delay:-11s;--snowOpacity:.18;--snowDrift:22px"></span>
          <span class="cardSnowFlake" style="left:38%;width:6px;height:6px;animation-duration:17s;animation-delay:-6s;--snowOpacity:.24;--snowDrift:12px"></span>
          <span class="cardSnowFlake" style="left:49%;width:5px;height:5px;animation-duration:19.5s;animation-delay:-9s;--snowOpacity:.20;--snowDrift:19px"></span>
          <span class="cardSnowFlake" style="left:58%;width:4px;height:4px;animation-duration:15.8s;animation-delay:-13s;--snowOpacity:.18;--snowDrift:9px"></span>
          <span class="cardSnowFlake" style="left:67%;width:6px;height:6px;animation-duration:18.8s;animation-delay:-8s;--snowOpacity:.26;--snowDrift:16px"></span>
          <span class="cardSnowFlake" style="left:76%;width:5px;height:5px;animation-duration:16.8s;animation-delay:-5s;--snowOpacity:.21;--snowDrift:13px"></span>
          <span class="cardSnowFlake" style="left:84%;width:4px;height:4px;animation-duration:21s;animation-delay:-10s;--snowOpacity:.17;--snowDrift:24px"></span>
          <span class="cardSnowFlake" style="left:91%;width:5px;height:5px;animation-duration:17.8s;animation-delay:-3s;--snowOpacity:.22;--snowDrift:15px"></span>
        </div>
        <div class="top">
          <div class="brand">
