...
function renderAdminHtmlServer(options = {}) {
  ...
  const today = options.today || {
    day: getVNDayKey(),
    admin: { android: 0, ios: 0 },
    free: { android: 0, ios: 0 }
  };
  ...
  const stats = [
    ["Admin Android hôm nay", today.admin.android, "Thiết bị Android dùng key admin"],
    ["Admin iOS hôm nay", today.admin.ios, "Thiết bị iOS dùng key admin"],
    ["Free Android hôm nay", today.free.android, "Thiết bị Android lấy key free"],
    ["Free iOS hôm nay", today.free.ios, "Thiết bị iOS lấy key free"],
    ...
    [
      "Tổng thiết bị hôm nay",
      Number(today.admin.android || 0) +
        Number(today.admin.ios || 0) +
        Number(today.free.android || 0) +
        Number(today.free.ios || 0),
      "Tổng login hợp lệ theo ngày"
    ]
  ];
          ...
          ${
            !authenticated
              ...
              : `
                <div class="panelBlock">
                  <div class="toolbarLine">
                    <div class="toolbarBadge">Hôm nay ${escapeHtml(today.day)}</div>
                    <div class="adminActions">
                      <form method="get" action="/${ADMIN_ROUTE}">
